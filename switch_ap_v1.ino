...
String  golova="<html><big><big><div align='center'><form action='led'><table style='font-size: 500%;' ><tr><td ",
...
form_p10=">On</label></td><td><label><input type='radio' name='state' value='0' onClick='this.form.submit();'",
form_p12=">On</label></td><td><label><input type='radio' name='state2' value='0' onClick='this.form.submit();'",
form_p13=">On</label></td><td><label><input type='radio' name='state3' value='0' onClick='this.form.submit();'",
